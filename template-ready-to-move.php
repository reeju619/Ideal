...
?>
<h1 class="d-none">Ready to Move Resiential Projects</h1>
<div class="main_content">
  <div class="big_slider">
    <div class="item">
      <img src="<?php bloginfo('template_directory');?>/images/ready-to-move_banner.jpg" alt="Ready To Move Banner">
    </div>
  </div>
  ...
  <section class="search_section search_section_inner">
	...
	<div class="media">
        ...
        while ($some->have_posts()): $some->the_post();
            ...
            ?>
                       <?php if (get_field('project_type') == 'Ready To Move In Projects' && (get_field('bhk_1') == '1 BHK')) {
	...
	<div id="tab3" class="tabcontent">
	  <div class="media">
        ...
        while ($some->have_posts()): $some->the_post();
            ...
            ?>
                       <?php if (get_field('project_type') == 'Ready To Move In Projects' && (get_field('bhk_2') == '2 BHK')) {
                        $twobhk = 1;?>
    ...
    <div id="tab4" class="tabcontent">
	  <div class="media">
        ...
        while ($some->have_posts()): $some->the_post();
            ...
            ?>
                       <?php if (get_field('project_type') == 'Ready To Move In Projects' && (get_field('bhk_3') == '3 BHK')) {
					$threebhk=$threebhk+1;
					?>
                         <div class="col_4">
    ...
    <div id="tab5" class="tabcontent">
	  <div class="media">
            ...
            while ($some->have_posts()): $some->the_post();            
            ?>
                       <?php if (get_field('project_type') == 'Ready To Move In Projects' && (get_field('bhk_4') == '4 BHK')) { 
                        $fourbhk = 1;?>
                         <div class="col_4">
